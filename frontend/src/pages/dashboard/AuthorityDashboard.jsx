...
export const AuthorityDashboard = () => {
  ...
  const refreshMyTasks = async () => {
    ...
    try {
      ...
      setTasksError(
        err?.response?.data?.message || "Failed to load assigned tasks",
      );
      setMyTasks([]);
    } finally {
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              ...
              <p className="text-gray-600 mb-6">
                Monitor water-related issues, respond to citizen reports, and
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-green-50 p-6 rounded-lg">
                  ...
                  <p className="text-gray-600">
                    {user?.location?.district || "Assigned District"}
                  </p>
                </div>
                ...
                <div className="space-y-4">
                  {tasksForTab.length === 0 ? (
                    ...
                    tasksForTab.map((task) => {
                      ...
                      const lastChangingLog =
                        getLastStatusChangingLog(groupLogs);
                ...
                <div className="bg-white rounded-lg border border-gray-200 p-6 shadow-sm">
                  ...
                  {!selectedTask ? (
                    ...
                    (!selectedTask.cancelledByRole ||
                      selectedTask.cancelledByRole === "admin") ? (
                    <div className="p-4 rounded-lg bg-gray-50 border border-gray-300 text-gray-700">
                      <p className="font-semibold text-gray-900 mb-2">
                        📋 Task Cancelled by Admin
                      </p>
                      <p className="text-sm text-gray-600">
                        This task has been cancelled by the admin and will be
                        reassigned to another authority. You cannot log water
                        samples for this task anymore.
                      </p>
                    ...
                    <>
                      <div className="mb-4">
                        ...
                        <div className="text-xs text-gray-500 mt-2">
                          {selectedTask.reportId?.address ||
                            "No address available"}
                        </div>
                        {selectedLastStatusChangeLog && (
                          <div className="text-xs text-gray-600 mt-2">
                            Last status change from your log:{" "}
                            {selectedLastStatusChangeLog.safetyRating} •{" "}
                      ...
                      <div className="mb-4">
                        <div className="text-sm text-gray-700 font-semibold mb-2">
                          {isResolvedTab
                            ? "Water Log History (by you)"
                            : "Previous Water Logs (by you)"}
                        </div>
                        {logsLoading ? (
                          <div className="text-sm text-gray-600">
                            Loading water logs...
                          ...
                          <div className="text-sm text-gray-600">
                            No previous water logs for this report yet.
                          </div>
                        ) : (
                                ...
                                <div className="flex items-start justify-between gap-4">
                                  <div className="min-w-0">
                                    <div className="text-sm font-semibold text-gray-900 truncate">
                                      {log.safetyRating} • pH {log.phLevel},
                          ...
                          <form
                            onSubmit={async (e) => {
                              ...
                              if (!canUploadWaterLog) {
                                return setLogError(
                                  "This report is resolved. You cannot upload more water logs.",
                                );
                              }
                              ...
                              if (Number.isNaN(ph) || Number.isNaN(turb))
                                return setLogError(
                                  "pH Level and Turbidity must be numbers",
                                );
                              ...
                              try {
                                ...
                                setLogMessage(
                                  "Water log created. Report status may be updated automatically.",
                                );
                                setPhLevel("");
                                setTurbidity("");
                                setContaminantsText("");
