...
export const AdminTaskDashboard = () => {
  ...
  const handleCreateTask = async (payload) => {
    ...
    try {
      ...
      setSubmitSuccess('✓ Task created successfully. The report is now marked as In Progress.');
      setActiveView('list');
    ...
    <div className="space-y-6">
      ...
      {activeView === 'create' && (
        <div className="p-8 bg-white shadow-lg rounded-xl border border-[#608A9A]/20">
          <div className="mb-6">
            <h3 className="text-2xl font-bold text-[#00569c]">Create New Task</h3>
            <p className="text-gray-600 text-sm mt-2">Assign a pending report to an authority for investigation</p>
          </div>
          <TaskForm
