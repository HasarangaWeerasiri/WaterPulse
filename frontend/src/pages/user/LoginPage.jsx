      ...
      <div className="w-full max-w-md">
        ...
        <div className="p-8 bg-white shadow-2xl rounded-2xl">
          ...
          <div className="mb-8 text-center">
            ...
            <h1 className="mb-2 text-3xl font-bold text-gray-900">WaterPulse</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 transition border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-2 font-semibold text-white transition bg-blue-600 rounded-lg hover:bg-blue-700 disabled:bg-gray-400 disabled:cursor-not-allowed"
            >
          ...
          <Link
            to="/register"
            className="block w-full px-4 py-2 font-semibold text-center text-gray-700 transition border border-gray-300 rounded-lg hover:bg-gray-50"
          >
            Create New Account
          </Link>
